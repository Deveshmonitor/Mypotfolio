    ...
    return (
        <>
            ...
            <div className="flex justify-between w-[96%] m-auto pt-8">
                ...
                <div className="w-full ">
                    <h1 className="text-fuchsia-500 text-8xl font-bold text-center my-4 ">About Me</h1>
                    ...
                    <h1 className="text-8xl font-bold text-gray-400 opacity-25 text-center z-10 ">Developer</h1>
                </div>
            </div>
